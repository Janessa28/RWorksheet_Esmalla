...
```{r name, echo = TRUE} 
#1
shoesize_vec<- c(6.5,9.0,8.5,8.5,10.0,7.0,9.5,9.0,13.0,7.5,10.5,8.5,12.5,10.5,13.5,11.5,8.5,5.0,10.0,6.5,7.5,8.5,10.5,8.5,10.5,11.0,9.0,13.0)
height_vec <- c(66.0,68.0,64.5,65.0,70.0,64.0,70.0,71.0,72.0,64.0,74.5,67.0,71.0,71.0,77.0,72.0,59.0,62.0,72.0,66.0,64.0,67.0,73.0,69.0,72.0,70.0,69.0,70.0)
gender_vec <-c("F","F","F","F","M","F","F","F","M","F","M","F","M","M","M","M","F","F","M","F","F","M","M","F","M","M","M","M")



householdData <- data.frame(Shoesize = shoesize_vec,
                            Height = height_vec,
                            Gender = gender_vec)
...
# 2
months_vec <- c("March","April","January","November","January","September","October","September","November","August","January","November","November","February","May","August","July","December","August","August","September","November","February","April")

months_vec

factor_months_vec <- factor(months_vec)
...
imported_table <- read.table(file =  "/cloud/project/Rworksheet_Esmalla#4/import_march.csv", header = TRUE, sep = ",")
